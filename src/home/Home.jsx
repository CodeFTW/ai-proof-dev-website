    ...
    <div className="flex flex-col gap-4 md:gap-10">
      ...
      <div className="flex w-full flex-col justify-between mt-3 grow">
        ...
        <h2 className="text-lg text-tertiary md:text-xl gap-2 flex-col flex md:ml-0 font-light">
          ...
          <p>
            ✔︎ ︎Battle-tested, yes, everything we teach was used in real life projects successfully.
          </p>
          <p>
      ...
      <div className="flex w-full flex-col justify-between mt-3 grow gap-4">
        ...
        <h2 className="text-lg text-tertiary md:text-xl gap-2 flex-col flex md:ml-0 font-light">
          <p>
            We publish it weekly (starting on March 25th 2024) on our platform only for paid members.
          </p>
          <p>
      ...
      <div className="flex w-full flex-col justify-between mt-3 grow">
        ...
        <h2 className="text-lg text-tertiary md:text-xl gap-2 flex-col flex md:ml-0 font-light">
          <p>
            Check our <a className="text-lime-500 font-normal" href="/content">Content</a>. Especially the second list.
          </p>
        </h2>
      </div>
    </div>
